...
<header>
	<nav class="container">
		<ul>
			<li class="mono">
				<a href="/"><strong>maximilian_trimarchi</strong></a>
			</li>
		</ul>
		<ul>
			<li>
				<a aria-label="GitHub Link" href="https://github.com/0xStephenHawking" target="_blank">
...
<footer class="pico-background-primary">
	<div class="container">
		<nav>
			<ul>
				<li>
